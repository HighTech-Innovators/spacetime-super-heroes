...
pub trait add_event {
    ...
    fn add_event(&self, name: String) -> __sdk::Result<()>;
...
impl add_event for super::RemoteReducers {
    fn add_event(&self, name: String) -> __sdk::Result<()> {
        self.imp.call_reducer("add_event", AddEventArgs { name })
    }
    fn on_add_event(
        &self,
        ...
        AddEventCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::AddEvent { name },
                            ..
                        },
                    ..
                } = ctx

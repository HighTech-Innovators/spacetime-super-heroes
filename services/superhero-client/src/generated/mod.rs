    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "event" => db_update.event = event_table::parse_table_update(table_update)?,
                "fight" => db_update.fight = fight_table::parse_table_update(table_update)?,
                "hero" => db_update.hero = hero_table::parse_table_update(table_update)?,
                "location" => {
                    db_update.location = location_table::parse_table_update(table_update)?
                }
                "villain" => db_update.villain = villain_table::parse_table_update(table_update)?,
